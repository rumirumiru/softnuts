                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            ...
                            <form name="login"
                                action="<?php echo base_url('index.php/Home_controller/login_check'); ?>"
                                method="POST" enctype="multipart/form-data charset=utf-8">

                                <div class="form-group mb-3">
                                    <label for="emailaddress">Email address</label>
                                    <input class="form-control" type="email" name="email_address" id="email"
                    ...
                    <div class="row mt-3">
                        <div class="col-12 text-center">
                            ...
                            <p class="text-muted">Don't have an account? <a href="register.html"
                                    class="text-primary font-weight-medium ml-1">Sign Up</a></p>
                        </div> <!-- end col -->
                    </div>
                    <!-- end row -->
